...
def _evaluate_all_cells_v2(
    ...
    cmax_A,
    cmax_B,
    cmax_temp,  # <-- pre-computed (replaces table_x/table_y)
    react_dist_A,
    react_dist_B,
    turbid_threshold,
    turbid_min,
    ...
    """Like _evaluate_all_cells but accepts pre-computed cmax_temp scalar.

    This avoids passing variable-length cmax tables into the batch loop.
    Returns (best_cell, best_activity, best_fitness, best_growth).
    """
    n_cand = candidate_indices.shape[0]
    best_cell = candidate_indices[0]
