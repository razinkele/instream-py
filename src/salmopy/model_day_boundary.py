...
class _ModelDayBoundaryMixin:
    ...
    def _apply_accumulated_growth(self):
        ...
        from salmopy.modules.growth import apply_growth_vectorized
    ...
    def _do_migration(self):
        ...
        from salmopy.modules.migration import (
            migration_fitness,
            should_migrate,
    ...
    def _do_adult_arrivals(self):
        ...
        from salmopy.io.arrival_reader import compute_daily_arrivals
