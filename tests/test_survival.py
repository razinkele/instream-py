...
class TestFishPredationSurvival:
    def test_large_fish_safer(self):
        ...
        s_small = survival_fish_predation(
            length=3.0, depth=30.0, light=20.0, pisciv_density=1e-6,
            temperature=10.0, activity="drift", min_surv=0.97,
            L1=3.0, L9=6.0, D1=35.0, D9=5.0, P1=5e-6, P9=-5.0,
            I1=50.0, I9=-50.0, T1=6.0, T9=2.0, hiding_factor=0.5)
        s_large = survival_fish_predation(
            length=15.0, depth=30.0, light=20.0, pisciv_density=1e-6,
            temperature=10.0, activity="drift", min_surv=0.97,
            L1=3.0, L9=6.0, D1=35.0, D9=5.0, P1=5e-6, P9=-5.0,
            I1=50.0, I9=-50.0, T1=6.0, T9=2.0, hiding_factor=0.5)
    ...
    def test_hiding_improves_survival(self):
        from instream.modules.survival import survival_fish_predation
        kwargs = dict(length=5.0, depth=30.0, light=20.0, pisciv_density=1e-6,
                      temperature=10.0, min_surv=0.97,
                      L1=3.0, L9=6.0, D1=35.0, D9=5.0, P1=5e-6, P9=-5.0,
                      I1=50.0, I9=-50.0, T1=6.0, T9=2.0, hiding_factor=0.5)
    ...
    def test_bounded(self):
        ...
        s = survival_fish_predation(
            length=5.0, depth=30.0, light=20.0, pisciv_density=1e-6,
            temperature=10.0, activity="drift", min_surv=0.97,
            L1=3.0, L9=6.0, D1=35.0, D9=5.0, P1=5e-6, P9=-5.0,
            I1=50.0, I9=-50.0, T1=6.0, T9=2.0, hiding_factor=0.5)
...
class TestTerrestrialPredationSurvival:
    def test_deep_water_safer(self):
        ...
        kwargs = dict(length=5.0, velocity=30.0, light=20.0,
                      dist_escape=100.0, activity="drift",
                      available_hiding=5, superind_rep=1, min_surv=0.94,
                      L1=6.0, L9=3.0, D1=0.0, D9=200.0, V1=20.0, V9=300.0,
                      I1=50.0, I9=-10.0, H1=200.0, H9=-50.0, hiding_factor=0.8)
    ...
    def test_hiding_improves_survival(self):
        from instream.modules.survival import survival_terrestrial_predation
        kwargs = dict(length=5.0, depth=30.0, velocity=30.0, light=20.0,
                      dist_escape=100.0, min_surv=0.94, available_hiding=5, superind_rep=1,
                      L1=6.0, L9=3.0, D1=0.0, D9=200.0, V1=20.0, V9=300.0,
                      I1=50.0, I9=-10.0, H1=200.0, H9=-50.0, hiding_factor=0.8)
    ...
    def test_bounded(self):
        ...
        s = survival_terrestrial_predation(
            length=5.0, depth=30.0, velocity=30.0, light=20.0,
            dist_escape=100.0, activity="drift",
            available_hiding=5, superind_rep=1, min_surv=0.94,
            L1=6.0, L9=3.0, D1=0.0, D9=200.0, V1=20.0, V9=300.0,
            I1=50.0, I9=-10.0, H1=200.0, H9=-50.0, hiding_factor=0.8)
...
class TestCombinedSurvival:
    ...
    def test_step_length_exponent(self):
        from instream.modules.survival import non_starve_survival
        daily = non_starve_survival(s_high_temp=0.9, s_stranding=1.0,
                                     s_fish_pred=0.95, s_terr_pred=0.95)
        half_day = daily ** 0.5
