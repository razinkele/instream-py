...
KNOWN_GEOMETRY_DRIFT: dict[tuple[str, str], str] = {
    ...
    # Upper (chain-end junction 5) instead of Mouth (mouth-end junction
    # 1→2), and k=2 BFS only reaches Upper. Fixed by raising marine
    # connectivity hops to 10 — marine reaches now traverse the full
    # connected component to find their geographically-adjacent
    # river reach (Mouth, at the far end of the chain). Both fixtures
    # now pass without registry entries.
}
